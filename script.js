...
//column1 items
var titlescore1 = document.createElement("h5");
titlescore1.innerHTML = "TEAM 1 SCORE BOARD";
document.getElementById("column1").appendChild(titlescore1);
var score1 = document.createElement("h2");
score1.innerHTML = "0";
score1.setAttribute("id", "score1");
document.getElementById("column1").appendChild(score1);
...
//column3 items
var titlescore2 = document.createElement("h5");
titlescore2.innerHTML = "TEAM 2 SCORE BOARD";
document.getElementById("column3").appendChild(titlescore2);
var score2 = document.createElement("h2");
score2.innerHTML = "0";
score2.setAttribute("id", "score2");
document.getElementById("column3").appendChild(score2);
...
var generate_result = document.createElement("button");
generate_result.setAttribute("class", "btn btn-primary");
generate_result.setAttribute("id", "generate_result");
generate_result.innerHTML = "GENERATE RESULT";
document.getElementById("table_column2").appendChild(generate_result);
//result
var result = document.createElement("h5");
result.setAttribute("class", "h5 mt-5");
result.setAttribute("id", "result");
document.getElementById("table_column2").appendChild(result);
//man of the match
var man = document.createElement("h5");
man.setAttribute("id", "man");
document.getElementById("table_column2").appendChild(man);
    ...
    function Game() {
        ...
        this.resetTimer = function () {
            ...
            //AFTER SECOND TEAM COMPLETES IT'S TURN
                ...
                generate_result.addEventListener("click", game.handleWinner);
            }
        };
        ...
        this.handleWinner = function () {
            ...
            if (team1 > team2) {
                document.getElementById("result").innerHTML = "MATCH WON BY TEAM 1";
            }
            else if (team1 < team2) {
                document.getElementById("result").innerHTML = "MATCH WON BY TEAM 2";
            }
            else {
